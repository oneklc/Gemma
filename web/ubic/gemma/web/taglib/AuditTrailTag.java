 ...
 * @author pavlidis
 * @version $Id: AuditTrailTag.java,v 1.2 2006/10/22 17:30:25 paul Exp $
 */
    ...
    public int doStartTag() throws JspException {
        ...
        if ( this.auditTrail == null ) {
            ...
            for ( AuditEvent auditEvent : ( List<AuditEvent> ) auditTrail.getEvents() ) {
                buf.append( "<li>" );
                buf.append( auditEvent.getDate() + ": " + auditEvent.getAction() /*
                                                                                     * + " by " +
                                                                                     * auditEvent.getPerformer().getUserName()
                                                                                     */+ ( auditEvent.getNote() == null ? " " : " Note: " )
                        + auditEvent.getNote() );
                buf.append( "</li>" );
            }
            buf.append( "</ol>" );
