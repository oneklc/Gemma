 ...
 * 
 * @author pavlidis
 * @version $Id: FastRowAccessDoubleMatrix.java,v 1.2 2010/04/07 15:52:35 paul Exp $
 */
public class FastRowAccessDoubleMatrix<R, C> extends DoubleMatrix<R, C> {
    ...
    public DoubleMatrix<R, C> getRowRange( int startRow, int endRow ) {
        ...
        DoubleMatrix<R, C> returnval = new FastRowAccessDoubleMatrix<R, C>( endRow - startRow, this.columns() );
